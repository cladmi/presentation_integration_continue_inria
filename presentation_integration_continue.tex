...
\tikzset{
  ...
  mstep3/.style = {basic, rounded corners=2pt, thin, align=center, fill=green!30,text width=5cm},
...
\subsection{Problématiques autour des tests}
\begin{frame}{L'automatisation de l'étape de tests}
...
% The second level, relatively positioned nodes
    \begin{scope}[every node/.style={level 3}]
      ...
      \node [right of = c21,xshift=2cm] (dynamic_analysis) {analyses dynamiques};
    \end{scope}
...
%  \node[mstep1] (integ) { Intégration continue };
  ...
  \node[below=.2cm of build_r1,mstep2] (build_r) {collectes des résultats};
