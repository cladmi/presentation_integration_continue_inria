...
\begin{frame}{Automatisation de l'étape de test}
\begin{block}{Quelques éléments}
  \begin{itemize}
  \item respect des rêgles de codage : pep8 (python), KWStyle (c++)
  \item analyse statique    : pylint, clang static analyzer
  \item analyse dynamique   : valgrind
  \item tests unitaires : cppunit (c++), unittest, pytest (python),junit (java)
  \item \dots
  \end{itemize}
\end{block}
\end{frame}
